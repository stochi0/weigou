...
from weigou.model import FinalProjection
from weigou.utils import assert_no_meta_tensors, print
...
class InitializationManager:
    ...
    def get_layer_names_in_sft_format(self):
        ...
        # NOTE: Safetensors may have tied embeddings, but Weigou does not support it. We always create a new lm_head.
        if isinstance(self.model, PipelineParallel):
